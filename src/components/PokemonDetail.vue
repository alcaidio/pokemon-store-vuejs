    ...
    <div class="detail-view" v-if="pokemonData && pokemonDescription">
      ...
      <div class="data">
        ...
        <div class="property">
          ...
          <div class="right">{{ pokemonData.price }} $</div>
        </div>
        <h3>Pokemon Types</h3>
        <div class="types">
          <div
      ...
      <div class="action">
        ...
        <button class="button add" @click="addProduct(pokemonData)">buy</button>
      </div>
    </div>
...
export default {
  ...
  methods: {
    async getDataSpecificPokemon(id) {
      ...
      return { ...json, price: price, quantity: 1};
    },
